...
(function() {
		...
		resource: {
			...
			tags: [
				...
				},
				{
					...
					once_per_event: true,
					vtp_html:
						'\u003Cscript data-gtmsrc="//platform.twitter.com/oct.js" type="text/gtmscript"\u003E\u003C/script\u003E\n\u003Cscript type="text/gtmscript"\u003Etwttr.conversion.trackPid("l69cu",{tw_sale_amount:0,tw_order_quantity:0});\u003C/script\u003E',
	...
	var n = function(a) {
		...
		for (var b in a)
			a.hasOwnProperty(b) &&
				(ka(b) ? (this.m[Number(b)] = a[Number(b)]) : this.Ha.set(b, a[b]));
	};
	f = n.prototype;
	f.toString = function() {
	...
	var Na = function(a, b) {
			for (
				var c, d = 0;
				d < b.length && !((c = Ma(a, b[d])), c instanceof ja);
				d++
			);
			return c;
		},
	...
	var Pa = /^([a-z]*):(!|\?)(\*|string|boolean|number|Fn|Map|List)$/i,
		Qa = { Fn: 'function', Map: 'Object', List: 'Array' },
		Ra = function(a, b) {
 ...
 jQuery v1.9.1 (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
	...
	var Wa = function(a) {
			if (a instanceof n) {
				for (var b = [], c = a.length(), d = 0; d < c; d++)
					a.has(d) && (b[d] = Wa(a.get(d)));
				return b;
			}
			if (a instanceof Oa) {
				for (var e = {}, g = a.da(), h = g.length(), k = 0; k < h; k++)
					e[g.get(k)] = Wa(a.get(g.get(k)));
				return e;
			}
		...
		Xa = function(a) {
			...
			var g = typeof a;
			if (null === a || 'string' === g || 'number' === g || 'boolean' === g)
				return a;
		};
	var Ya = {
			...
			return new x(
				...
				(function() {
					return function(a) {
						...
						d.Bb && b.S(d.Bb);
						for (
							var c = Array.prototype.slice.call(arguments, 0), h = 0;
							h < c.length;
							h++
						)
							if (((c[h] = this.evaluate(c[h])), c[h] instanceof ja))
								return c[h];
						for (var p = e.get('length'), q = 0; q < p; q++)
							q < c.length ? b.set(e.get(q), c[q]) : b.set(e.get(q), void 0);
	...
	var ab = {
		...
		concat: function(a, b) {
			...
			for (var e = 1; e < arguments.length; e++)
				if (arguments[e] instanceof n)
					for (var g = arguments[e], h = 0; h < g.length(); h++)
						c.push(g.get(h));
		...
		every: function(a, b) {
			for (var c = this.length(), d = 0; d < this.length() && d < c; d++)
				if (this.has(d) && !b.B(a, this.get(d), d, this)) return !1;
			return !0;
		},
		filter: function(a, b) {
			for (
				...
				this.has(e) && b.B(a, this.get(e), e, this) && d.push(this.get(e));
			return new n(d);
		},
		forEach: function(a, b) {
			for (var c = this.length(), d = 0; d < this.length() && d < c; d++)
				this.has(d) && b.B(a, this.get(d), d, this);
		},
		...
		map: function(a, b) {
			for (
				...
				this.has(e) && (d[e] = b.B(a, this.get(e), e, this));
			return new n(d);
		},
		pop: function() {
			return this.pop();
		...
		reduce: function(a, b, c) {
			...
			for (var k = g; k < d; k++)
				this.has(k) && (e = b.B(a, e, this.get(k), k, this));
			return e;
		},
	...
	z.sd = function(a, b) {
		...
		a instanceof Oa || a instanceof n || a instanceof x
			? (c = a.get(b))
			: 'string' == typeof a &&
			  ('length' == b ? (c = a.length) : ka(b) && (c = a[b]));
		return c;
	};
	z.vf = function(a, b) {
		return this.evaluate(a) > this.evaluate(b);
	...
	z['switch'] = function(a, b, c) {
		...
		if (
			...
			d instanceof ja && ('return' == d.C || 'continue' == d.C))
		)
			return d;
	};
	z.xg = function(a, b, c) {
		...
		Fb = function(a, b, c, d, e) {
			...
			switch (b) {
				...
				case 'protocol':
					...
					break;
				case 'host':
					g = (a.hostname || B.location.hostname).replace(Cb, '').toLowerCase();
					if (c) {
						var l = /^www\d*\./.exec(g);
	...
	var Gb = function(a, b, c) {
		...
		Mb = function(a, b, c, d, e, g) {
			c = c || '/';
			var h = (d = d || 'auto'),
				k = c;
			if (Kb.test(document.location.hostname) || ('/' === k && Lb.test(h)))
				return !1;
			...
			if ('auto' === d) {
				...
				a: {
					...
					for (var v = u.length - 2; 0 <= v; v--) r.push(u.slice(v).join('.'));
					r.push('none');
					q = r;
				}
				for (var D = q, G = 0; G < D.length && !p; G++)
					p = Mb(a, b, c, D[G], e);
				return p;
			}
			d && 'none' !== d && (m += 'domain=' + d + ';');
	...
	function Hb(a, b) {
		for (var c = [], d = Gb(a), e = 0; e < d.length; e++) {
			...
			if (!b || -1 !== b.indexOf(h)) {
				...
				k &&
					((k = k.split('-')),
					c.push({ id: g.join('.'), jf: 1 * k[0] || 1, $f: 1 * k[1] || 1 }));
			}
		}
		return c;
	}
	...
	function cc(a, b, c, d) {
		...
		if (d) {
			var k = d;
			kc[k]
				? (kc[k].onSuccess.push(g), kc[k].onFailure.push(h))
				: ((kc[k] = { onSuccess: [g], onFailure: [h] }),
				  (g = function() {
	...
	function mc(a) {
		for (var b = 0; b < a.length; b++) {
			...
			c &&
				ha(c) &&
				Object.defineProperty(c, 'gtm', { value: { fromContainer: !0 } });
		}
	}
	function lc(a) {
	...
	function fc(a, b) {
		...
		try {
			return (
				this.F().assert.apply(null, Array.prototype.slice.call(arguments, 0)),
				!0
			);
		} catch (c) {
			return !1;
		...
		Vc = function(a, b, c, d) {
			if (wa(a)) {
				...
				switch (a[0]) {
					...
					case 'escape':
						e = Vc(a[1], b, c, d);
						if (Rc && wa(a[1]) && 'macro' === a[1][0] && Rc.Kf(a))
							return Rc.cg(e);
						e = String(e);
					...
					case 'tag':
						var w = a[1];
						if (!Nc[w])
							throw Error('Unable to resolve tag reference ' + w + '.');
						return (e = { nd: a[2], index: w });
					case 'zb':
 ...
 Copyright (c) 2014 Derek Brans, MIT license https://github.com/krux/postscribe/blob/master/LICENSE. Portions derived from simplehtmlparser, which is licensed under the Apache License, Version 2.0 */
	...
	var Hd = function(a) {
		...
		Ed.test(B.location && B.location.hostname) &&
			((d = Da(d)), d.push('nonGooglePixels', 'nonGoogleScripts'));
		var e = d && La(Da(d), Gd),
			g = {};
		return function(h) {
			var k = h && h[N.wa];
			...
			if (d) {
				...
				if (!(u = 0 <= xa(e, k)))
					a: {
						for (var w = l || [], v = new Ga(), D = 0; D < e.length; D++)
							v.set(e[D], !0);
	...
	var Id = {
		Ze: function(a, b) {
			b[N.Jc] &&
				'string' === typeof a &&
				(a = 1 == b[N.Jc] ? a.toLowerCase() : a.toUpperCase());
	...
	var de = function() {
		...
		me = function() {
			...
			void 0 === fe ||
				...
				(ie[fe] || je.Lf() || 0 >= ke--
					? (ie[fe] = !0)
					: (je.jg(), rb(le()), (ge[fe] = !0), (he = '')));
		},
		le = function() {
			var a = fe;
			return void 0 === a
				? ''
				: [ne, ge[a] ? '' : '&es=1', oe[a], de(), he, '&z=0'].join('');
		},
		pe = function() {
	...
	var T = { Nb: 'event_callback', Ob: 'event_timeout' };
	var Ge = {},
		Ie = function(a) {
			var b = fd.o;
			return function() {
	...
	var Me = null,
		...
		Qe = function(a, b) {
			...
			b &&
				((c.eventModel = y(b)),
				b[T.Nb] && (c.eventCallback = b[T.Nb]),
				b[T.Ob] && (c.eventTimeout = b[T.Ob]));
			return c;
		};
	var Ue = {
		config: function(a) {},
		...
		policy: function(a) {
			if (3 === a.length) {
				var b = a[1],
					c = a[2];
				(c && ha(c) && c.gtm && c.gtm.fromContainer) ||
					(Ge[b] || (Ge[b] = []), Ge[b].push(c));
			}
		},
		set: function(a) {
			var b;
			2 == a.length && Va(a[1])
				? (b = y(a[1]))
				: 3 == a.length && t(a[1]) && ((b = {}), (b[a[1]] = a[2]));
			if (b)
				return (
					(b.eventModel = y(b)), (b.event = 'gtag.set'), (b._clear = !0), b
				);
		},
	};
	var $e = !1,
					...
					if (u) {
						...
						if (G.active) {
							...
							c: {
								...
								var R = Hd(V),
									ca = { id: O, name: I, callback: F || sa, ia: R, Za: [] };
								ca.Za = cd(R);
								for (
									var qa,
										Ca = ca,
								...
								ib.He();
								zb.sort(Ce);
								for (var Bd = 0; Bd < zb.length; Bd++) zb[Bd].M();
								qa = 0 < zb.length;
								if ('gtm.js' === I || 'gtm.sync' === I)
									d: {
									}
								if (qa) {
									for (
	...
	function Af(a) {
		...
		xf.Ja(
			Ie(function() {
				var a = arguments[0];
				return a && b[a]
					? b[a].apply(void 0, Array.prototype.slice.call(arguments, 0))
					: {};
			})
		);
		for (var d in a)
	...
	var Qf = function() {
			for (
				var a = hb.userAgent + (C.cookie || '') + (C.referrer || ''),
					b = a.length,
					c = B.history.length;
				0 < c;
	...
	function sg(a, b, c) {
		for (var d = {}, e = {}, g = hg().decorators, h = 0; h < g.length; ++h) {
			...
			(!c || k.forms) &&
				gg(k.domains, b) &&
				(k.fragment ? Ja(e, k.callback()) : Ja(d, k.callback()));
		}
		if (Ka(d)) {
			var l = og(d);
			if (c) {
	...
	var zg = /^\w+$/,
		Ag = /^[\w-]+$/,
		Bg = /^~?[\w-]+$/,
		Cg = { aw: '_aw', dc: '_dc', gf: '_gf', ha: '_ha' },
		Eg = function(a) {
			var b = Gb(a, C.cookie),
				c = [];
	...
	var Gg = function(a) {
			if (a) {
				...
				if (a && 'object' == typeof a)
					return { dc: Fg(a.dc), aw: Fg(a.aw), gf: Fg(a.gf), ha: Fg(a.ha) };
			}
			...
			if (b && b.length)
				for (var k = 0; k < b.length; k++) {
					...
					'1' == l[0] &&
						...
						l[1] &&
						(h[b[k].Bc] || (h[b[k].Bc] = []),
						h[b[k].Bc].push({ timestamp: l[1], sf: l[2] }));
				}
			var m = [],
				p;
			for (p in h)
	...
	var Ch = B.clearTimeout,
			...
			for (var l = Gg(b), m = 0; m < a.length; ++m) {
				...
				if (void 0 !== Cg[p]) {
					...
					if (r) {
						...
						w || Mb(q, r, c, d, new Date(u + 7776e6), !0);
					}
				}
			}
			var A = { prefix: b, path: c, domain: d };
		...
		Qh = function(a, b, c) {
			var d = (void 0 === c ? 0 : c) ? 'www.googletagmanager.com/gtag/js' : id;
			d += '?id=' + encodeURIComponent(a) + '&l=dataLayer';
			if (b)
				for (var e in b)
					b[e] &&
						b.hasOwnProperty(e) &&
						(d += '&' + e + '=' + encodeURIComponent(b[e]));
			W(J('https://', 'http://', d));
		};
	var Sh = jf.Pf;
	...
	var si = window,
		...
		ui = function(a) {
			...
			if ((b && b.ioo && b.ioo()) || (a && !0 === si['ga-disable-' + a]))
				return !0;
			try {
				var c = si.external;
	...
	(Y.a.f = ['google']),
		(function() {
			(function(a) {
				...
				var b = Gh('gtm.referrer', 1) || C.referrer;
				return b
		...
		(function() {
			var a = void 0,
				...
				h = function(a, b) {
					...
					var c = l(Eh()),
						d;
					d = wa(b.vtp_affiliatedDomains)
						? b.vtp_affiliatedDomains
						: String(b.vtp_affiliatedDomains || '')
								.replace(/\s+/g, '')
								.split(',');
			...
			(function(a) {
				...
				switch (e.vtp_varType) {
					case 'TAG_NAME':
						return Gh('gtm.element', 1).tagName || e.vtp_defaultValue;
					case 'TEXT':
						var k,
							l = Gh('gtm.element', 1),
							m = Gh('event', 1),
					...
					case 'URL':
						...
						a: {
							var v = String(
									Gh('gtm.elementUrl', 1) || e.vtp_defaultValue || ''
								),
								D = H(v);
					...
					case 'ATTRIBUTE':
						var G;
						if (void 0 === e.vtp_attribute) G = g(e);
						else {
							var A = Gh('gtm.element', 1);
							G = ub(A, e.vtp_attribute) || e.vtp_defaultValue || '';
						}
						return G;
					default:
						return g(e);
	...
	(Y.a.bzi = ['nonGoogleScripts']),
		(function() {
			(function(a) {
				...
				try {
					(B._bizo_data_partner_id = a.vtp_id),
						(B._bizo_data_partner_title = a.vtp_title),
						(B._bizo_data_partner_domain = a.vtp_domain),
						(B._bizo_data_partner_company = a.vtp_company),
						(B._bizo_data_partner_location = a.vtp_location),
						(B._bizo_data_partner_employee_range = a.vtp_employeeRange),
						(B._bizo_data_partner_sics =
							a.vtp_standardIndustrialClassification),
						(B._bizo_data_partner_email = a.vtp_email),
						W(
							J('https://sjs', 'http://js', '.bizographics.com/insight.min.js'),
							a.vtp_gtmOnSuccess,
							a.vtp_gtmOnFailure
						);
				} catch (b) {
					...
					try {
						if (0 < c.length) {
							var d = c.shift(),
								e = a(b, c, g, h);
							if (
								'SCRIPT' == String(d.nodeName).toUpperCase() &&
								'text/gtmscript' == d.type
							) {
								...
								d.innerHTML &&
								0 <= d.innerHTML.toLowerCase().indexOf('<script')
							) {
								for (var q = []; d.firstChild; )
									q.push(d.removeChild(d.firstChild));
			...
			var c = function(d) {
				if (C.body) {
					var e = d.vtp_gtmOnFailure,
						g = Sh(d.vtp_html, d.vtp_gtmOnSuccess, e),
						h = g.hc,
						k = g.X;
					if (d.vtp_useIframe) {
					} else
						d.vtp_supportDocumentWrite ? b(h, k, e) : a(C.body, xb(h), k, e)();
				} else
					Dh(function() {
						c(d);
					}, 200);
	...
	(Bi.macro = function(a) {
		...
		(Bi.onHtmlSuccess = jf.jd(!0)),
		(Bi.onHtmlFailure = jf.jd(!1));
	Bi.dataLayer = wd;
