...
var _hsq = _hsq || [];
var _paq = _paq || [];
_hsq.push(['setPortalId', 425470]);
_hsq.push(['trackPageView']);
_hsq.push([
	'trackClick',
	'div#navbar.wrap > div.inner > div.user-panel > ul > li.upgrade.text > a',
	'000000155613',
]);
_hsq.push(function(t) {
	t.urlMatches('http://www.invisionapp.com/') &&
		t.trackClick(
			'div#main-nav-wrapper.container > div.inside > nav > ul > li:eq(3) > a',
			'000000157790'
		);
});
_hsq.push(function(t) {
	t.urlMatches('http://www.invisionapp.com/') &&
		t.trackClick('a#home-cta', '000000489213');
});
_hsq.push(function(t) {
	t.urlMatches('http://www.invisionapp.com/enterprise') &&
		t.trackClick(
			'body.enterprise.alt.large-viewport > header.hero.video-loaded > div.hero-container > p.hero-button.button.blue > a',
			'000000489246'
		);
});
_hsq.push(function(t) {
	t.urlMatches('http://www.invisionapp.com/enterprise') &&
		t.trackClick('input#submit_enterprise_demo_request', '000000489247');
});
_hsq.push(function(t) {
	t.urlMatches('http://www.invisionapp.com/enterprise') &&
		t.trackClick(
			'div#main-nav-wrapper.container.navigation > div.inside > nav > ul > li.signup > a.button.trial-trigger.enterprise-trigger',
			'000000489248'
		);
});
_hsq.push(['trackClick', '.ent_banner_on .fixed-ad-button', '000000763501']);
_hsq.push(['trackClick', '#enterprise_offer_modal .button a', '000000769920']);
_hsq.push(['trackClick', '.ent_request_cta', '000000843951']);
_hsq.push(['trackClick', '.ent_start_cta', '000000843952']);
_hsq.push(function(t) {
	t.urlMatches('https://www.designbetter.co/') &&
		t.trackClick(
			'div#container > div.home > figure.masthead.full-bg > figcaption > div.rendered-content > a.btn.default',
			'000002262926'
		);
});
_hsq.push(function(t) {
	t.urlMatches('https://www.designbetter.co/') &&
		t.trackClick(
			'div#__next > div > div > header.site-header.past-threshold > nav.hide-for-small > a:eq(0)',
			'000002262927'
		);
});
_hsq.push(function(t) {
	t.urlMatches('https://www.designbetter.co/') &&
		t.trackClick(
			'div#container > div.home > div.home-books > div.book-excerpt.full-block.animate > div.wrapper > aside > a.btn.default:eq(0)',
			'000002262932'
		);
});
_hsq.push(function(t) {
	t.urlMatches('https://www.designbetter.co/') &&
		t.trackClick(
			'div#container > div.home > div.home-books > div.book-excerpt.full-block.animate:eq(1) > div.wrapper > aside > a.btn.default',
			'000002262933'
		);
});
_hsq.push(function(t) {
	t.urlMatches('https://www.designbetter.co/') &&
		t.trackClick(
			'div#__next > div > div > footer.full-block > div.skinny.wrapper > a.btn.default',
			'000002263072'
		);
});
_hsq.push(function(t) {
	t.urlMatches('https://www.designbetter.co/') &&
		t.trackClick(
			'div#__next > div > div > header.site-header.past-threshold > nav.hide-for-small > a:eq(1)',
			'000002263076'
		);
});
_hsq.push(function(t) {
	t.urlMatches('https://www.designbetter.co/') &&
		t.trackClick(
			'div#__next > div > div > header.site-header.past-threshold > nav.hide-for-small > a:eq(2)',
			'000002263078'
		);
});
_hsq.push(function(t) {
	t.urlMatches('https://www.designbetter.co/') &&
		t.trackClick(
			'div#container > div.home > div.home-books > div.book-excerpt.full-block.animate:eq(2) > div.wrapper > aside > a.btn.default',
			'000002263080'
		);
});
_hsq.push([
	'trackClick',
	'div#ppc-signup > div.pistanos-form-container.styles__FormContainer-s10f3iwi-0.fFPuPq.pistanos-viewed > form > div.actions.SignUp__Actions-vsn4kk-2.fryLEe > button.button__StyledButton-s1ghumtr-0.cAzwlf',
	'000002444145',
]);
_hsq.push(function(t) {
	t.urlMatches(
		'https://www.invisionapp.com/webinars/design-systems-fireside-chat'
	) && t.trackClick('div#unlocked > a.pistanos-late', '000002600183');
});
_hsq.push(function(t) {
	t.urlMatches(
		'https://www.invisionapp.com/webinars/design-systems-fireside-chat'
	) && t.trackClick('div#unlocked > a.pistanos-late', '000002600187');
});
_hsq.push([
	'trackClick',
	'div#container > div.home > div.home-books > div.book-excerpt.full-block.animate:eq(3) > div.wrapper > aside > a.btn.default.pistanos',
	'000002622617',
]);
_hsq.push(function(t) {
	t.urlMatches('https://www.designbetter.co/') &&
...
_hsq.push(function(t) {
	t.urlMatches(
		'https://www.invisionapp.com/webinars/design-culture?utm_medium=paid_social&utm_source=linkedin&utm_campaign=DG_ENT_L_NAM_Social_FiresideChat_TA'
	) && t.trackClick('section#gateway > a.pistanos-late', '000006004938');
});
_hsq.push(['setLegacy', false]);
_hsq.push(['addCookieDomain', '.muz.li']);
_hsq.push(['addCookieDomain', '.designdisruptors.com']);
_hsq.push(['addCookieDomain', '.myshopify.com']);
_hsq.push(['addCookieDomain', '.hs-sites.com']);
_hsq.push(['addCookieDomain', '.hubspot.com']);
_hsq.push(['addCookieDomain', '.invisionapp.com']);
_hsq.push(['addCookieDomain', '.invision.works']);
	...
	[
		{
			...
			privacyBannerAccentColor: '#00bda5',
...
_hsq.push([
	'embedHubSpotScript',
	'https://js.hs-scripts.com/425470.js',
	'hs-script-loader',
]);
/** _anon_wrapper_ **/ (function() {
	function load() {
		...
		function i() {
			...
			if (
				...
				(t.addEventListener && 'loaded' == t.readyState)
			) {
				e();
				return !0;
			}
	...
	hstc.utils.getNextMonthStart = function(t) {
		for (
			var e = t || new Date(), i = e.getMonth(), n = 0;
			i == e.getMonth();
	...
	hstc.utils.each = function(t, e) {
		...
		} else for (var o = t[0]; r > n && e.call(o, n, o) !== !1; o = t[++n]);
		return t;
	};
				...
				if (2 === s.length) {
					...
					if (l)
						for (; l >= h; h++) {
							a = '' === u[h] ? c.length : u[h];
							c = c[a] =
								l > h ? c[a] || (u[h + 1] && isNaN(u[h + 1]) ? {} : []) : o;
						}
					else
						hstc.utils.isArray(i[a])
							? i[a].push(o)
							: void 0 !== i[a]
							? (i[a] = [i[a], o])
							: (i[a] = o);
	...
	hstc.utils.logError = function(t, e) {
		...
		hstc.utils.loadImage(
			'https://' + hstc.ANALYTICS_HOST + '/__pto.gif?' + hstc.utils.param(i)
		);
	};
	...
	hstc.utils.eq = function(t, e, i) {
		...
		if ('[object Array]' == n) {
			o = t.length;
			s = o == e.length;
			if (s) for (; o-- && (s = o in t == o in e && eq(t[o], e[o], i)); );
		} else {
			if (
			...
			for (var a in t)
				if (_.has(t, a)) {
					o++;
					if (!(s = _.has(e, a) && eq(t[a], e[a], i))) break;
				}
			if (s) {
	...
	hstc.cookies.Cookie.prototype.set = function(t, e, i) {
		...
		this._set(t, i.alreadyEncoded ? e : hstc.utils.encodeParam(e, !0), {
			...
			domain:
				!this.setCookiesToSubdomain && this.currentDomain
	...
	hstc.critsits.PrivacyPolicySept2018.prototype.handle = function(t) {
		if (this.matchedCookiePolicy.active) {
			...
			if (!e.isNew()) {
				...
				if (
					!(
						i < hstc.critsits.PrivacyPolicySept2018.START_MILLIS ||
						i > hstc.critsits.PrivacyPolicySept2018.END_MILLIS
					)
				) {
	...
	hstc.tracking.Tracker.prototype.setPrivacyConsent = function(t) {
		this.privacyConsent = { allowed: t };
		for (var e = 0; e < this.privacyConsentListeners.length; e++)
			this._safeCallListener(
				this.privacyConsentListeners[e],
				this.privacyConsent
			);
	};
	...
	hstc.tracking.Tracker.prototype.addPrivacyConsentListener = function(t) {
		null !== this.privacyConsent &&
			this._safeCallListener(t, this.privacyConsent);
				...
				try {
					if (t(n))
						try {
							...
							n &&
								n.href &&
								hstc.utils.logError('Unable to modify link to ' + n.href);
						}
				} catch (o) {
	...
	hstc.tracking.Tracker.prototype.handleLink = function(t, e, i) {
		...
		if (null !== r) {
			...
			n = hstc.utils.updateQueryStringParameter(
				n,
				'__hssc',
				this.session.get()
			);
	...
	hstc.tracking.Tracker.prototype.trackClick = function(t, e, i) {
		...
		try {
			...
			hstc.log(
				'Bad selector for ' + this.portalId + ': ' + t + ', for event ' + e
			);
		}
	};
	...
	hstc.tracking.Tracker.prototype._manageCookies = function(t, e, i) {
		if (!this.managedCookies || i) {
			...
			if (this.cookiesEnabled) {
				this.utk.save(this.privacySettings);
				this.session.save();
			}
	...
	hstc.tracking.Tracker.prototype._extractIdentitiesFromQueryString = function(
		...
		i.__hs_email &&
			this.identify({ email: hstc.utils.decodeParam(i.__hs_email) }, !0);
			...
			if (i.__hsfp) {
				...
				if (i.__hstc) {
					var s = hstc.tracking.Utk.parse(
						this.cookie,
						hstc.utils.safeString(i.__hstc)
					);
						...
						if (hstc.utils.hashDomain(i) == s.domain) {
							if (t.recovered) {
								if (t.visitor !== s.visitor) {
									n.utk = t;
									n.identify({ visitor: s.visitor }, !0);
								}
							} else {
								n.utk = s;
								n.utk.resetDomain();
	...
	hstc.tracking.Tracker.prototype._getPageInfo = function() {
		...
		if (
			...
			for (
				var i = [], n = Math.min(this.targetedContentMetadata.length, 5), r = 0;
				n > r;
				r++
			) {
	...
	hstc.tracking.Tracker.prototype._getPrivacyInfo = function() {
		...
		this.privacySettings &&
			('OPT_IN' == this.privacySettings.mode && this.privacySettings.hideDecline
				...
				? (t.pt = 1)
				: 'NO_COOKIES' == this.privacySettings.mode && (t.pt = 2));
		this.cookiesEnabled || (t.ce = !1);
		return t;
	};
		...
		if (e) {
			for (
				var n,
					...
					s,
					a =
						this.context.getLocation().hash.indexOf('_hsPrivacyTest') > -1 ||
						this.context.getLocation().search.indexOf('_hsPrivacyTest') > -1,
					c = { 0: 'DISABLED', 1: 'OPT_IN', 2: 'NO_COOKIES' },
					h = 0;
				h < e.length;
				h++
			) {
				...
				if (u.privacyDefault && (u.enabled || a))
					...
					var l =
							(u.enabled || a) &&
							u.domain &&
							this.context.getHostName() === u.domain,
						p =
							(u.enabled || a) &&
							u.path &&
							hstc.utils.startsWith(this.context.getPathName(), u.path),
						d = {
							active: u.enabled,
							testing: a,
							mode: c[u.privacyPolicy],
			...
			var g = (this.privacySettings = s || o || r || n);
			if (g && 'DISABLED' !== g.mode) {
				if (i)
					try {
						new hstc.critsits.PrivacyPolicySept2018(
							this.context,
							this.cookie,
							g
						).handle();
				...
				if ('OPT_IN' == g.mode) hstc.privacy.optInHandler(this, hstc, g);
				else if ('NO_COOKIES' == g.mode)
					hstc.privacy.noCookiesHandler(this, hstc, g);
				else {
					hstc.utils.logError(new Error('Unknown privacy mode: ' + g.mode));
	...
	hstc.tracking.Tracker.prototype.revokeCookieConsent = function() {
		...
		for (
			var t = [
					hstc.privacy.OPT_OUT_COOKIE,
					hstc.tracking.Session.COOKIE,
					hstc.tracking.Session.RESTART_COOKIE,
					hstc.tracking.Tracker.DO_NOT_TRACK,
					hstc.tracking.Utk.COOKIE,
					hstc.tracking.Utk.LEGACY_COOKIE,
				],
				e = 0;
			e < t.length;
			e++
		)
			this.cookie.remove(t[e]);
	...
	hstc.tracking.Utk.prototype.save = function(t) {
		if (!t || 'OPT_IN' != t.mode || this.isNew()) {
	...
	hstc.privacy.OPT_OUT_COOKIE = '__hs_opt_out';
	hstc.privacy.OPT_OUT_COOKIE_EXPIRATION = 390;
	hstc.privacy.optInHandler = function(t, e, i) {
		function n() {
			...
			o(
				(t + '-webkit- '.split(' ').join(e + t) + a.join(i + t)).slice(
					0,
					-t.length
				),
				s
		...
		if (s || a) {
			...
			if (!a) {
				if (
					!p &&
					(y.get(e.tracking.Utk.COOKIE) || y.get(e.tracking.Session.COOKIE))
				) {
					t.setPrivacyConsent(!0);
					return;
				}
				t.cookiesEnabled = p;
				if (p && 'no' == y.get(e.privacy.OPT_OUT_COOKIE)) {
					t.setPrivacyConsent(!0);
					return;
				}
				if ('yes' == y.get(e.privacy.OPT_OUT_COOKIE) || !y.has() || !c) {
			...
			if (!x) {
				var T =
					'<div id="hs-eu-cookie-confirmation" class="' +
					k +
					'"><div id="hs-eu-cookie-confirmation-inner"><p style="">{{0}}</p>{{3}}<div id="hs-en-cookie-confirmation-buttons-area"><a href="#" id="hs-eu-confirmation-button">{{1}}</a>';
				p || (T += '<a href="#" id="hs-eu-decline-button">{{2}}</a>');
				T += '</div></div></div>';
				T = T.replace('{{0}}', c).replace('{{1}}', h ? h : 'Accept');
				T = p
					? T.replace('{{3}}', '')
					: T.replace('{{2}}', u ? u : "Don't ask me again").replace(
							'{{3}}',
							l ? '<p id="hs-eu-cookie-disclaimer">' + l + '</p>' : ''
					  );
				var _ = b.getDocument(),
					E = _.body,
					S = _.createElement('style');
				S.setAttribute('type', 'text/css');
				if (S.styleSheet) S.styleSheet.cssText = v;
				else {
					var I = _.createTextNode(v);
					S.appendChild(I);
				}
				var O = _.body.childNodes[0];
				E.insertBefore(S, O);
				E.insertBefore(e.utils.createElement(T), O);
				var D = e.find('#hs-eu-cookie-confirmation')[0],
					N = E.style.paddingTop;
				E.style.paddingTop = D.offsetHeight;
				n && n() && (D.className = (D.className || '') + ' can-use-gradients');
				var A = e.find('#hs-eu-confirmation-button')[0];
				e.utils.addEventListener(A, 'click', function(i) {
					e.utils.preventDefault(i);
					D.style.display = 'none';
					E.style.paddingTop = N;
					if (!a) {
						t.cookiesEnabled = !0;
						t._manageCookies(t.utk, t.session, !0);
						y.set(e.privacy.OPT_OUT_COOKIE, 'no', {
							daysToExpire: e.privacy.OPT_OUT_COOKIE_EXPIRATION,
				...
				if (!p) {
					var L = e.find('#hs-eu-decline-button')[0];
					e.utils.addEventListener(L, 'click', function(i) {
						e.utils.preventDefault(i);
						D.style.display = 'none';
						E.style.paddingTop = N;
						if (!a) {
							y.set(e.privacy.OPT_OUT_COOKIE, 'yes', {
								daysToExpire: e.privacy.OPT_OUT_COOKIE_EXPIRATION,
								domain: e.utils.extractDomain(t.context.getHostName()),
								path: '/',
							});
	...
	!(function(t) {
		function e(t, e, i, n) {
			var r, o, s, a, c, h, u, d, g, f;
			(e ? e.ownerDocument || e : j) !== A && N(e);
			e = e || A;
			i = i || [];
			...
			if (P && !n) {
				...
				if (w.qsa && (!R || !R.test(t))) {
					...
					if (1 === a && 'object' !== e.nodeName.toLowerCase()) {
						...
						c = h.length;
						for (; c--; ) h[c] = d + p(h[c]);
						g = (pt.test(t) && e.parentNode) || e;
						f = h.join(',');
					}
					if (f)
						try {
							tt.apply(i, g.querySelectorAll(f));
							return i;
						} catch (m) {
						} finally {
		...
		function l(t, i) {
			...
			for (; a; ) {
				...
				if ((r = lt.exec(a))) {
					n = r.shift();
					o.push({ value: n, type: r[0].replace(ht, ' ') });
					a = a.slice(n.length);
				}
				for (s in _.filter)
		...
		function m(t, e, i, r, o, s) {
			...
			return n(function(n, s, a, c) {
				var h,
					...
					d = [],
					g = s.length,
					m = n || y(e || '*', a.nodeType ? [a] : a, []),
					k = !t || (!n && e) ? m : f(m, p, t, a, c),
					v = i ? (o || (n ? t : g || r) ? [] : s) : k;
				i && i(k, v, a, c);
				if (r) {
					h = f(v, d);
				...
				if (n) {
					if (o || t) {
						if (o) {
							h = [];
							u = v.length;
							for (; u--; ) (l = v[u]) && h.push((k[u] = l));
							o(null, (v = []), h, c);
						}
						u = v.length;
						for (; u--; )
							(l = v[u]) &&
								(h = o ? it.call(n, l) : p[u]) > -1 &&
								(n[h] = !(s[h] = l));
					}
				} else {
					v = f(v === s ? v.splice(g, v.length) : v);
		...
		function k(t) {
			for (
				...
				if ((i = _.relative[t[a].type])) u = [d(g(u), i)];
				else {
					i = _.filter[t[a].type].apply(null, t[a].matches);
					if (i[K]) {
						n = ++a;
						for (; r > n && !_.relative[t[n].type]; n++);
						return m(
							a > 1 && g(u),
							a > 1 &&
								p(
			...
			var r = 0,
				...
				a = function(n, a, c, h, u) {
					var l,
						...
						y = null != u,
						b = O,
						x = n || (s && _.find.TAG('*', (u && a.parentNode) || a)),
						C = (B += null == b ? 1 : Math.random() || 0.1),
						w = x.length;
					if (y) {
						O = a !== A && a;
						T = r;
					}
					for (; k !== w && null != (l = x[k]); k++) {
						if (s && l) {
							p = 0;
							for (; (d = t[p++]); )
								if (d(l, a, c)) {
					...
					if (o && k !== m) {
						...
						for (; (d = i[p++]); ) d(v, g, a, c);
						if (n) {
							if (m > 0) for (; k--; ) v[k] || g[k] || (g[k] = J.call(h));
							g = f(g);
						}
						tt.apply(h, g);
						y && !n && g.length > 0 && m + i.length > 1 && e.uniqueSort(h);
					}
					if (y) {
						B = C;
						O = b;
		...
		function b(t, e, i, n) {
			...
			if (!n && 1 === h.length) {
				...
				if (
					...
					e = (_.find.ID(s.matches[0].replace(Ct, wt), e) || [])[0];
					if (!e) return i;
				...
				for (; r--; ) {
					...
					if (
						(c = _.find[a]) &&
						(n = c(
							s.matches[0].replace(Ct, wt),
							(pt.test(o[0].type) && e.parentNode) || e
						))
					) {
						o.splice(r, 1);
						t = n.length && p(o);
		...
		try {
			tt.apply((Q = et.call(j.childNodes)), j.childNodes);
		...
		N = e.setDocument = function(t) {
			...
			_.find.CLASS =
				w.getElementsByClassName &&
				function(t, e) {
					return typeof e.getElementsByClassName !== G && P
						? e.getElementsByClassName(t)
						: void 0;
				};
			U = [];
			R = [];
			if ((w.qsa = kt.test(e.querySelectorAll))) {
				r(function(t) {
			...
			F =
				kt.test(L.contains) || L.compareDocumentPosition
					? function(t, e) {
			...
			V = L.compareDocumentPosition
				? function(t, i) {
						...
						return n
							? 1 & n || (!w.sortDetached && i.compareDocumentPosition(t) === n)
								? t === e || F(j, t)
									? -1
									: i === e || F(j, i)
									? 1
									: D
									? it.call(D, t) - it.call(D, i)
									: 0
								: 4 & n
								? -1
								: 1
				...
				: function(t, i) {
						...
						n = i;
						for (; (n = n.parentNode); ) h.unshift(n);
						for (; c[r] === h[r]; ) r++;
		...
		e.matchesSelector = function(t, i) {
			...
			i = i.replace(dt, "='$1']");
			if (w.matchesSelector && P && (!U || !U.test(i)) && (!R || !R.test(i)))
				try {
					var n = M.call(t, i);
					if (
						n ||
		...
		_ = e.selectors = {
			...
			preFilter: {
				ATTR: function(t) {
					t[1] = t[1].replace(Ct, wt);
					t[3] = (t[4] || t[5] || '').replace(Ct, wt);
					'~=' === t[2] && (t[3] = ' ' + t[3] + ' ');
					return t.slice(0, 4);
				},
				CHILD: function(t) {
				...
				PSEUDO: function(t) {
					var e,
						i = !t[5] && t[2];
					if (mt.CHILD.test(t[0])) return null;
			...
			filter: {
				TAG: function(t) {
					var e = t.replace(Ct, wt).toLowerCase();
					return '*' === t
						? function() {
								return !0;
						  }
							...
							H(t, function(t) {
								return e.test(
									('string' == typeof t.className && t.className) ||
										(typeof t.getAttribute !== G && t.getAttribute('class')) ||
										''
								);
							}))
					);
								...
								if (m) {
									if (o) {
										for (; f; ) {
											...
											for (; (l = l[f]); )
												if (
													a ? l.nodeName.toLowerCase() === k : 1 === l.nodeType
												)
													return !1;
									...
									if (s && v) {
										...
										p = h[0] === B && h[2];
										l = d && m.childNodes[d];
										for (; (l = (++d && l && l[f]) || (p = d = 0) || g.pop()); )
											if (1 === l.nodeType && ++p && l === e) {
												u[t] = [B, d, p];
												break;
											}
									} else if (v && (h = (e[K] || (e[K] = {}))[t]) && h[0] === B)
										p = h[1];
									else
										for (; (l = (++d && l && l[f]) || (p = d = 0) || g.pop()); )
											if (
				...
				PSEUDO: function(t, i) {
					...
					if (o.length > 1) {
						r = [t, t, '', i];
						return _.setFilters.hasOwnProperty(t.toLowerCase())
							? n(function(t, e) {
		...
		for (C in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })
			_.pseudos[C] = a(C);
		for (C in { submit: !0, reset: !0 }) _.pseudos[C] = c(C);
			...
			this.each = function(t, i, n) {
				if (null !== t)
					if (e && t.forEach === e) t.forEach(i, n);
						...
						for (var s in t)
							if (t.hasOwnProperty(s) && i.call(n, t[s], s, t) === {}) return;
			};
		...
		t.prototype = {
			...
			murmurhash3_32_gc: function(t, e) {
				...
				for (; n > h; ) {
					...
					++h;
					c =
						((65535 & c) * s + ((((c >>> 16) * s) & 65535) << 16)) & 4294967295;
					c = (c << 15) | (c >>> 17);
					c =
						((65535 & c) * a + ((((c >>> 16) * a) & 65535) << 16)) & 4294967295;
					r ^= c;
					r = (r << 13) | (r >>> 19);
					o =
